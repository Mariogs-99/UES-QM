 ...
 */
@Entity
@Table(name = "GC_CONF_REPRO", catalog = "", schema = "")
@NamedQueries({
    @NamedQuery(name = "GcConfRepro.findAll", query = "SELECT g FROM GcConfRepro g")})
public class GcConfRepro implements Serializable {
...
//    private List<GcMultimedia> gcMultimediaList;
    ...
    public GcConfRepro(TbUnidadRecep cUnidadRecep) {
        this.cUnidadRecep = cUnidadRecep;
    }

    public GcConfRepro(Long nOrden) {
        this.nOrden = nOrden;
    }
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GcConfRepro)) {
            return false;
        }
        GcConfRepro other = (GcConfRepro) object;
