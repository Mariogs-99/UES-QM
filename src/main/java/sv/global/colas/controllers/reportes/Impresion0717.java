 ...
 */
@Controller
@RequestMapping("/impresion0717")
@EnableAsync
public class Impresion0717 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0717.jasper";
    ...
    response.setHeader("Content-disposition", "inline; filename=0717.pdf");
