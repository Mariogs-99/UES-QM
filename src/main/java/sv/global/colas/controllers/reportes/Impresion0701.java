 ...
 */
@Controller
@RequestMapping("/impresion0701")
@EnableAsync
public class Impresion0701 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo="";
    String s=req.getParameter("MM");
    if (s.equals("HH AM"))
        archivo=env.getProperty("dgii.jasper.reportes") + "0701.jasper";
    else
        archivo=env.getProperty("dgii.jasper.reportes") + "0701A.jasper";
...
//    parameters.put("Tramite", new Integer(req.getParameter("Tramite")));
    ...
    response.setHeader("Content-disposition", "inline; filename=0701.pdf");
...
//    parameters.put("Tramite", new Integer(req.getParameter("Tramite")));
   ...
   // String spr=System.getProperty("java.awt.headless");
   // System.out.println("Prop: "+spr);
  ...
  {
        String archivo=env.getProperty("dgii.jasper.reportes") + "0701.jasper";
        JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(archivo);
        Map parameters = new HashMap();
        parameters.put("Icono1", env.getProperty("dgii.jasper.reportes")+"esa.png");
        parameters.put("Icono2", env.getProperty("dgii.jasper.reportes")+"logoMh.png");
