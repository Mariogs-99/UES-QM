 ...
 */
@Controller
@RequestMapping("/impresion0706")
@EnableAsync
public class Impresion0706 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0706.jasper";
...
//    parameters.put("Tramite", new Integer(req.getParameter("Tramite")));
    ...
    parameters.put("Tiquete",req.getParameter("Tiquete"));
    Conexion();
    
    JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, parameters ,con);
    response.setContentType("application/x-pdf");
    response.setHeader("Content-disposition", "inline; filename=0706.pdf");
