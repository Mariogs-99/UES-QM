 ...
 */
@Controller
@RequestMapping("/impresion0720")
@EnableAsync
public class Impresion0720 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=""; //env.getProperty("dgii.jasper.reportes") + "0720.jasper";
    int tipo=new Integer(req.getParameter("detalle"));
    if (tipo==1)      
      archivo=env.getProperty("dgii.jasper.reportes") + "0720A.jasper";
    else
      archivo=env.getProperty("dgii.jasper.reportes") + "0720.jasper";
    ...
    response.setHeader("Content-disposition", "inline; filename=0720.pdf");
