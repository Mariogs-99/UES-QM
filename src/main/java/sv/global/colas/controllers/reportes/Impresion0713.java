 ...
 */
@Controller
@RequestMapping("/impresion0713")
@EnableAsync
public class Impresion0713 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0713.jasper";
    ...
    response.setHeader("Content-disposition", "inline; filename=0713.pdf");
