 ...
 */
@Controller
@RequestMapping("/impresion0719")
@EnableAsync
public class Impresion0719 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0719.jasper";
    ...
    response.setHeader("Content-disposition", "inline; filename=0719.pdf");
