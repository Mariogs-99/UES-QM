 ...
 */
@Controller
@RequestMapping("/impresion0711")
@EnableAsync
public class Impresion0711 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0711.jasper";
...
//    parameters.put("Tramite", new Integer(req.getParameter("Tramite")));
    ...
    response.setHeader("Content-disposition", "inline; filename=0711.pdf");
