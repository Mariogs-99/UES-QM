 ...
 */
@Controller
@RequestMapping("/impresion0716")
@EnableAsync
public class Impresion0716 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0716.jasper";
    ...
    response.setHeader("Content-disposition", "inline; filename=0716.pdf");
