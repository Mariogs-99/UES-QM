 ...
 */
@Controller
@RequestMapping("/impresion0715")
@EnableAsync
public class Impresion0715 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0715.jasper";
    ...
    parameters.put("Tecnico", req.getParameter("Tecnico"));
//    parameters.put("Tramite", new Integer(req.getParameter("Tramite")));
    ...
    response.setHeader("Content-disposition", "inline; filename=0715.pdf");
