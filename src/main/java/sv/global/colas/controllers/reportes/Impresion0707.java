 ...
 */
@Controller
@RequestMapping("/impresion0707")
@EnableAsync
public class Impresion0707 {
    @PersistenceContext
  ...
  public void getRpt1(HttpServletResponse response, HttpServletRequest req) throws JRException, IOException, SQLException, ClassNotFoundException {
    String archivo=env.getProperty("dgii.jasper.reportes") + "0707.jasper";
...
//    parameters.put("Tramite", new Integer(req.getParameter("Tramite")));
    ...
    response.setHeader("Content-disposition", "inline; filename=0707.pdf");
