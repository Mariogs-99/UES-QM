...
var Raphael = (function (type) {
        ...
        if (type == "VML") {
            ...
            r._create = function () {
                // containe, width, height
                // x, y, width, height
                var containe, width, height;
                if (typeof arguments[0] == "string") {
                    containe = document.getElementById(arguments[0]);
                    width = arguments[1];
                    height = arguments[2];
                }
                if (typeof arguments[0] == "object") {
                    containe = arguments[0];
                    width = arguments[1];
                    height = arguments[2];
                }
                ...
                if (!containe) {
                    throw new Error("VML containe not found.");
                }
                ...
                if (containe == 1) {
                    ...
                    cs.width = containe.style.width = width;
                    cs.height = containe.style.height = height;
                    if (containe.firstChild) {
                        containe.insertBefore(c, containe.firstChild);
                    } else {
                        containe.appendChild(c);
                    }
                }
                for (var prop in C) {
                    containe[prop] = C[prop];
                }
                containe.clear = function () {
                    var todel = [];
        ...
        if (type == "SVG") {
            ...
            r._create = function () {
                ...
                // x, y, width, height
                if (typeof arguments[0] == "string") {
                    var containe = document.getElementById(arguments[0]);
                    var width = arguments[1];
                    var height = arguments[2];
                }
                if (typeof arguments[0] == "object") {
                    var containe = arguments[0];
                    var width = arguments[1];
                    var height = arguments[2];
                }
                if (typeof arguments[0] == "number") {
                ...
                if (!containe) {
                    throw new Error("SVG containe not found.");
                }
                ...
                if (containe == 1) {
                    ...
                    if (containe.firstChild) {
                        containe.insertBefore(C.canvas, containe.firstChild);
                    } else {
                        containe.appendChild(C.canvas);
                    }
                }
                containe = {
                    canvas: C.canvas,
